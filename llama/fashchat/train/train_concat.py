...
def make_supervised_data_module(
    ...
    train_dataset = ConstantLengthDataset(tokenizer, train_json, dataset_text_field="question_answer",seq_length=4096)
    if data_args.eval_data_path:
        eval_json = json.load(open(data_args.eval_data_path, "r"))
        eval_dataset = ConstantLengthDataset(tokenizer, eval_json, dataset_text_field="question_answer",seq_length=4096)
