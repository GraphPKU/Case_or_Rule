...
def gen_rf_rationale(a: BaseInt, b: BaseInt):
    import prompt_base10 as prompt
...
if __name__ == '__main__':
    ...
    test_num = 14
    do_mask = True
    with open('test_sample_addition.pkl', 'rb') as rf:
        import pickle
    ...
    for test_time in tqdm(range(test_num), total=test_num):
        ...
        for test_sample in tqdm(test_samples):
            ...
            similar_icl_samples = generate_similar_icl_sample(num=5, a=a, b=b, similar='replace', num_digit=3, sure_every_digit=False)
            ...
            result_save_name = f'addition_{task}'
            import os
